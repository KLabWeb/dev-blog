...
function domWarp() {
  ...
  //video change
  newVideo("clownvideo", "video/webm", "assets/video/grandma.webm");
  newVideo("clownvideo", "video/mp4", "assets/video/grandma.mp4");
  ...
  body[0].style.backgroundImage = "url(assets/images/back.gif)";
