  ...
  <main>
    ...
    <section>
      ...
      <div class="pdf-container">
        <iframe src="../notes/head_first_notes.pdf" class="pdf-double"></iframe>
    ...
    <section>
      ...
      <br>
      <p class="plaintext">In the second example, now with cleaner code, note how both the high-level and low-level classes are both dependent on the interface. test.php references Animals and does not care what type of Animal they are. Likewise, all implementations of Animal are dependent on the Animal interface. This allows for high flexibility, extensibility, and results in clean, decoupled code</p>
      <br>
      <div class="grid-code-container">
        <pre class="grid-code"><code>
          class AnimalFeeder{
